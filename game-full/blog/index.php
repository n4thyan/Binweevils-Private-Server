...
<head>
	...
	<title>Bin News - Bin Weevils Private Server</title>
...
<body>
	...
	<div class="central-container bwps-homepage-page">
		...
		<div class="download-section bwps-page-heading">
			<p class="bwps-kicker">NEWS</p>
			<h1>Bin News</h1>
			<p class="bwps-home-copy">News, fixes and feature notes for the Bin Weevils private server.</p>
		</div>

		<div class="download-buttons bwps-page-button-row">
			<a href="/play/"><button class="button bwps-yellow-btn">Play now</button></a>
		</div>

		<div class="bwps-page-card-stack">
<div class="bwps-home-card">
					<h2>Recent work</h2>
					<p>Ruffle support, relaxed chat, moderator commands, XP banking, prestige progression and website polish.</p>
				</div>
<div class="bwps-home-card">
					<h2>Coming soon</h2>
					<p>More room systems, events and community features once they are tested properly.</p>
				</div>
<div class="bwps-home-card">
					<h2>Stable first</h2>
					<p>Working builds are merged, tagged and backed up before the next feature pass.</p>
				</div>
		</div>
	</div>
