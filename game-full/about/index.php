...
<head>
	...
	<title>About - Bin Weevils Private Server</title>
...
<body>
	...
	<div class="central-container bwps-homepage-page">
		...
		<div class="download-section bwps-page-heading">
			<p class="bwps-kicker">ABOUT</p>
			<h1>About</h1>
			<p class="bwps-home-copy">A community Bin Weevils private server with classic gameplay and custom features.</p>
		</div>

		<div class="download-buttons bwps-page-button-row">
			<a href="https://github.com/n4thyan/Binweevils-Private-Server"><button class="button bwps-yellow-btn">View GitHub</button></a>
		</div>

		<div class="bwps-page-card-stack">
<div class="bwps-home-card">
					<h2>Classic feel</h2>
					<p>The goal is to keep the original Bin Weevils feel while making the project easier to run and test.</p>
				</div>
<div class="bwps-home-card">
					<h2>Current features</h2>
					<p>Ruffle support, relaxed chat, moderator commands, XP banking and prestige progression.</p>
				</div>
<div class="bwps-home-card">
					<h2>Public testing</h2>
					<p>The site is being prepared so friends and testers can join from the VPS.</p>
				</div>
		</div>
	</div>
